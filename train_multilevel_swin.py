...
if __name__ == "__main__":
    ...
    print(f"📊 Feature Flow:")
    print(f"   Stage 1: [H/4×W/4, 96]   → Global pool → [96]")
    print(f"   Stage 2: [H/8×W/8, 192]  → Global pool → [192]") 
    print(f"   Stage 3: [H/16×W/16, 384] → Global pool → [384]")
    print(f"   Stage 4: [H/32×W/32, 768] → Global pool → [768]")
    print(f"   Concat: [96+192+384+768=1440] → Fusion → [{cfg.EMBED_DIM}]")
